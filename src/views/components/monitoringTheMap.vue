    ...
    <el-row>
      <el-col :span="24">
        <div style="width: 100%; height: 100%">
          <div id="chinaMap" :style="{ height: '750px' }" />
        </div>
      </el-col>
    </el-row>
  </div>
...
<script>
import realTimeAlarmDataRotation from "./realTimeAlarmDataRotation";
import systemCoverageIndex from "./systemCoverageIndex";
import echarts from "echarts/lib/echarts";
require("../../../static/china");
export default {
  name: "MapDemo",
  components: { systemCoverageIndex, realTimeAlarmDataRotation },
  data() {
    return {
      mapIndex: [],
      mapIndexCode: "",
          ...
          normal: {
            ...
            areaColor: {
              ...
              colorStops: [
                ...
                {
                  offset: 1,
                  color: "rgba(147, 235, 248, .05)", // 100% 处的颜色
                },
              ],
      ...
      return {
        ...
        series: [
          this.mapdsadas,
          {
            ...
            data: [
              { name: "北京", value: [116.405285, 39.904989, 177] },
              { name: "成都", value: [103.9526, 30.7617, 82] },
            ],
            showEffectOn: "render",
            rippleEffect: {
              brushType: "stroke",
